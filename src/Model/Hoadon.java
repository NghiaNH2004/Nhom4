...
public class Hoadon {
    ...
    public String toString() {
        return "Hoadon{" + "idHoaDon=" + idHoaDon + ", idNhanVien=" + idNhanVien + ", ngayTao=" + ngayTao + ", trangThai=" + trangThai + ", trangThaiTT=" + trangThaiTT + ", thanhTien=" + thanhTien + ", lyDoHuy=" + lyDoHuy + ", slSanPhamHuy=" + slSanPhamHuy + ", ghiChu=" + ghiChu + ", SDT=" + SDT + ", ten=" + ten + ", diaChi=" + diaChi + ", tienShip=" + tienShip + '}';
    }
