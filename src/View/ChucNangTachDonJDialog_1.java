 ...
 * @author HP
 */
public class ChucNangTachDonJDialog_1 extends javax.swing.JDialog {

    /**
     * Creates new form ChucNangTachDonJDialog
     */
    public ChucNangTachDonJDialog_1(java.awt.Frame parent, boolean modal, int hd, int ban) {
        super(parent, modal);
        initComponents();
...
//            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChucNangTachDonJDialog_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChucNangTachDonJDialog_1 dialog = new ChucNangTachDonJDialog_1(new javax.swing.JFrame(), true, idhd, idban);
